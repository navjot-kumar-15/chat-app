...
export const createGroupChat = async (req,res) => {
    try {
        ...
        const getGroupChat = await Chat.findOne({_id:createChat._id}).populate("users","-password").populate("groupAdmin","-password");
        return res.send({
            success:1,
...
export const renameGroup = async ( req,res) => {
    try {
        ...
        const renameChat = await Chat.findByIdAndUpdate(chatId,{chatName},{new:true}).populate("users","-password").populate("groupAdmin","-password");
